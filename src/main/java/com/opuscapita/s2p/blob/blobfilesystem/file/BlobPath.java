...
//import java.util.*;
//
//public class BlobPath extends AbstractBlobFileSystemProvider implements Path {
//
...
//
//    public BlobPath(BlobFileSystem fileSystem, String root, List<String> names) {
...
//    public BlobPath asT() {
//        return (BlobPath) this;
//    }
//
//    public BlobPath create(String root, String... names) {
//        return create(root, GenericUtils.unmodifiableList(names));
//    }
//
//    public BlobPath create(String root, Collection<String> names) {
//        return create(root, GenericUtils.unmodifiableList(names));
//    }
//
//    public BlobPath create(String root, List<String> names) {
...
//
//    @Override
//    public BlobPath relativize(Path other) {
//        BlobPath p1 = asT();
//        BlobPath p2 = checkPath(other);
...
//    @Override
//    public URI toUri() {
//        URI uri = URI.create(this.getFileSystem().getEndpoint() + this.toAbsolutePath());
//        return uri;
//    }
//
//    @Override
...
//        BlobPath p1 = asT();
//        BlobPath p2 = checkPath(paramPath);
...
//
//    @SuppressWarnings("unchecked")
//    protected BlobPath checkPath(Path paramPath) {
...
//        return this.getFileSystem().provider().getScheme();
//    }
//}
